    ...
    e.fn.gaugeMeter = function (t) {
        ...
        return this.each(function () {
            ...
            var b = e("<canvas></canvas>").attr({
                width: l.size,
                height: l.size
            }).appendTo(e(this)).get(0), g = b.getContext("2d"), m = b.width / 2, v = b.height / 2, _ = 360 * l.percent, x = (_ * (Math.PI / 180), b.width / 2.5), k = 2.3 * Math.PI, G = 0, M = 0 === l.animationstep ? c : 0, z = Math.max(l.animationstep, 0), P = 2 * Math.PI, I = Math.PI / 2, R = "";
